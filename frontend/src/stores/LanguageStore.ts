...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'tomes.title': 'Archive Tomes', 'tomes.allTomes': 'All Tomes', 'tomes.loading': 'Loading...',
    'tomes.empty': 'Catalog is empty. Run sync from the Admin panel.', 'tomes.permanent': 'Permanent content',
    ...
    'search.found': 'Found: {n}', 'search.page': 'Page',
  ...
  ru: {
    ...
    'tomes.title': 'Тома архивов', 'tomes.allTomes': 'Все тома', 'tomes.loading': 'Загрузка...',
    ...
    'search.found': 'Найдено: {n}', 'search.page': 'Стр.',
